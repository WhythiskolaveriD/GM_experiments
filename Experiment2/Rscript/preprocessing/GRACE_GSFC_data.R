...
library(ncdf4)
library(sp)
grace_nc <- nc_open(paste0(dd_root, "WP2-SolidEarth/Bramha/BHMinput/GRACE_trends_Oceanadded_Bramha.nc"))
print(grace_nc)
...
save(Land_spf, Ocean_spf, Antarctica, Greenland, grace_sp, gia_sp, Ocean, Land, v_ocean, v_land,
     file = paste0(dd_root, "WP1-BHM/Experiment2/data/Exp2_GSFC_grace.rda"))
