...
## Note that this script is also exactly the same as the GSFCgrid script.
## It is kept to differentiate between the two experiment in case you want to change some parameters here.
## It can be merged in the future.
...
if(file.exists(cache_mesh)){
  ...
  save(mesh0, region_vid, region_tid, mesh_land, mesh_ocean, mesh_bound, file = cache_mesh)
}
