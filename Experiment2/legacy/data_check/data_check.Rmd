...
In this file, we check the data and results of Experiment 2 regarding to GRACE and GIA. We calculate the integerted sum and average to check if the values makes sense. 
...
# GRACE original grid
Problem: need extra processing of the data!
