---
title: "Experiment 2C uing large foot print GRACE data"
author: "Z Sha"
date: "5 June 2018"
...
res_inla <- inla(formula, data = inla.stack.data(stkall), family = "gaussian",
                 ...
                 verbose = TRUE)
saveRDS(res_inla, file = "/./projects/GlobalMass/WP1-BHM/Experiment2c/Exp2c_a_lg.rds")
...
load(paste0(dd, "WP1-BHM/Experiment2c/Exp2c_a_lg.RData"))
